...
- Gắn **nhãn cấp 1 / cấp 2** cho từng bài học (VD: `IELTS ▸ Listening Part 3`) ngay khi thêm bài mới, thêm hàng loạt (áp dụng chung cho cả loạt hoặc chọn riêng từng bài), hoặc khi sửa bài; có thể tự tạo/**sửa tên**/xóa nhãn và gắn nhãn cho nhiều bài cùng lúc.
